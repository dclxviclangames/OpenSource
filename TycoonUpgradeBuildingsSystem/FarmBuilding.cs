...
public class FarmBuilding : MonoBehaviour, IBuilding
{
    ...
    public string buildingId = "Farm"; // Убедитесь, что это ID из вашего BuildingConfig (например, "Farm")
    ...
    void Start()
    {
        ...
        if (_resourceProducer != null)
        {
            ...
            //
            _resourceProducer.currentLevel = _currentSaveData.currentLevel; // Если уровни синхронизированы
        }
    }
  ...
  /*  private void Update()
    ...
    public void UpdateResourcesUI()
    {
        ...
        BuildingConfig config = BuildingManager.Instance.GetBuildingConfig(buildingId);
        ...
        sb.AppendLine($"{targetLevelConfig.cost}"); // Заголовок
